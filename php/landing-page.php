...
<body>
    <nav>
        ...
        <ol class="nav-lists">
            ...
            $uniInfoId = isset($_SESSION['uniInfoId'])?htmlspecialchars($_SESSION['uniInfoId']):"";
                if ($uniInfoId)
                {
            ?>
            <li>
            <a href="../university/myInfo.php" class="navbar-item">My Info</a>
            </li>
            <?php
                } else{
            ?>
            <li>
            <a href="../html/unilanding.php" class="navbar-item">Add College</a>
            </li>
            <?php
                }
            ?>
    ...
    <section class="featured-colleges">
        ...
        ?>
            ...
            <a href="./collegeDetails.php?id=<?=$row['id'];?>">
